...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="data-card">
        <span class="data-label">Motherboard Temperature: </span>
        <span id="mb-temperature-value" class="data-value">--.- °C</span>
      </div>
      <div class="data-card">
        <span class="data-label">Enclosure Temperature: </span>
        <span id="enclosure-temperature-value" class="data-value">--.- °C</span>
      </div>
      <div class="data-card">
        <span class="data-label">Printer State: </span>
        <span id="printer-state-value" class="data-value">----</span>
      </div>
      ...
      function fetchData() {
        ...
        xhttp.onreadystatechange = function () {
          if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("mb-temperature-value").innerHTML = data.motherboardTemperature.toFixed(2) + " °C";
            document.getElementById("enclosure-temperature-value").innerHTML =
              data.enclosureTemperature.toFixed(2) + " °C";
            document.getElementById("printer-state-value").innerHTML = data.printerState;
